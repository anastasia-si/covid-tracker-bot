...
from config import STATE_NAME, PERCENTAGE_CHANGE, URL
...
class CovidCaseMonitor:
    ...
    def get_total_cases(self):
        ...
        for tr in table.xpath(".//tr"):
            for td in tr.iterchildren():
                if STATE_NAME in td.text_content().upper():
    ...
    def report_total_case_change(self):
        ...
        if  new_total_cases >= prev_total_cases + PERCENTAGE_CHANGE * prev_total_cases:
            message = "Significant increase in the number of positive tests for COVID-19 in {0}.\n" \
                      "The total number of cases: {1}. \n" \
                      "(Previous value: {2}) \n" \
                      "Checked at: {3}".format(STATE_NAME.capitalize(),
                                               new_total_cases,
                                               prev_total_cases,
                                               time.ctime())
